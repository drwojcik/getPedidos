...
class ProgressBarTest extends \PHPUnit_Framework_TestCase {
	...
	public function testRedrawFrequency() {
		$bar = $this->getMock ( 'Symfony\Component\Console\Helper\ProgressBar', array (
				'display' 
		), array (
