...
* @version 1.5 => 2016-04-18 - Alterado o icone de + para ^
* alterado por Gabriel Henrique em 27/04/017 - ícone mudado para uma versão maior
*/
(function($){
	//TableGrid plugin
	$.fn.TableGrid = function(options) {
		...
		$(this).each(function(){
			...
			$(document).find('#'+idTable + ' > tbody > tr').each(function(){
				$(this).find('td:first').before('<td class="detailClose"> <a href="#" class="getDetail_'+ idTable +' btn btn-sm"><i class="fa fa-chevron-down" aria-hidden="true"></i></a> </td>');
			});
			//-----------------------------------------------------------
